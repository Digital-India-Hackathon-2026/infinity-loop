...
import { 
  Landmark, Search, ShieldCheck, MapPin, Eye, X, LogOut, Printer, Bell, Languages
} from 'lucide-react';
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            <button
              ...
              className="relative p-1.5 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-550 dark:text-slate-450 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors border-none flex items-center justify-center cursor-pointer"
            >
            ...
            {showNotifications && (
              <div className="absolute right-0 mt-2 w-72 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-2 rounded-2xl shadow-xl z-50 text-slate-700 dark:text-slate-205 max-h-80 overflow-y-auto">
